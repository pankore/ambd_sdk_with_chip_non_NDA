 ...
 *
 *
 * 0x083B6000 -------------------- MATTER_KVS_BEGIN_ADDR
 *
 * 0x083CF000 -------------------- MATTER_KVS_BEGIN_ADDR2
 */
...
#define MATTER_KVS_BEGIN_ADDR           0x003B6000  // 96K (4*24), DCT begin address of flash, ex: 0x100000 = 1M
...
// MATTER KVS2, for key length large than 64 (Fabric1 ~ Fabric5)
#define MATTER_KVS_BEGIN_ADDR2	        0x003DF000  // 20K (4*5)
